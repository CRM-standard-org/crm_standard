...
**ระบบ CRM Standard** เป็นระบบจัดการลูกค้าสัมพันธ์ (Customer Relationship Management) ที่ครอบคลุมกระบวนการขายแบบ End-to-End สำหรับธุรกิจขายส่งอุปกรณ์คอมพิวเตอร์และซอฟต์แวร์

#### วัตถุประสงค์ของระบบ
- จัดการข้อมูลลูกค้าและผู้ติดต่อแบบครอบคลุม
- ติดตามกระบวนการขายตั้งแต่การหาลูกค้าใหม่จนถึงการปิดการขาย
- วิเคราะห์ข้อมูลการขายและพยากรณ์ยอดขาย
- จัดการใบเสนอราคาและใบสั่งขายแบบอัตโนมัติ
- ติดตามผลงานของทีมขายและพนักงาน

#### ฟีเจอร์หลักที่มีอยู่ในระบบ
- **การจัดการลูกค้า**: ข้อมูลบริษัท, ผู้ติดต่อ, ที่อยู่, แท็ก, กิจกรรม
- **การขาย**: ใบเสนอราคา, ใบสั่งขาย, การอนุมัติ, การติดตาม
- **การจัดการสินค้า**: สินค้า, กลุ่มสินค้า, หน่วย, ราคา
- **การวิเคราะห์**: Dashboard, รายงาน, KPI, การพยากรณ์
- **การจัดการองค์กร**: ทีม, พนักงาน, สิทธิ์การใช้งาน
- **ข้อมูลพื้นฐาน**: สกุลเงิน, ภาษี, ที่อยู่, วิธีการชำระเงิน
...
## ⚠️ งานที่ต้องทำต่อ (จาก all-task.text)

### 🔴 **CRITICAL - Backend ที่ยังไม่เสร็จ**
- **การวิเคราะห์ติดตามผล** (ทั้งหมด PENDING Backend + Integration)
  - ติดตามกระบวนการขาย
  - การติดตามตัวชี้วัดสำคัญ (KPI)
  - คาดการณ์ยอดขาย (ระดับกิจการ/ทีม/บุคคล)
  - รายงานทั้ง 6 รายงาน
- **กำหนดข้อมูลพื้นฐานลูกค้า** (Backend + Integration)
- **บันทึกกิจกรรมลูกค้า** (Backend + Integration)
- **การจัดการบริษัท** (Backend + Integration)
- **การจัดการพนักงาน** (Backend + Integration)

### 🟡 **MEDIUM - งานที่กำลังดำเนินการ**
- **ที่อยู่**: ยังทำไม่ครบทุกจังหวัด ทุกอำเภอ ทุกตำบล
- **ใบสั่งขาย**: การแก้ไขและเปลี่ยนสถานะ (IN PROCESS)

### 🟢 **LOW - UI/UX Fixes**
- **Responsive Design**: บางหน้าในหน้าจอมือถือมีปัญหา
  - ตัว input ของ label เงื่อนไขการชำระเงิน
  - `/Feature/Financial/edit-info-quotation`
  - `/Feature/Financial/edit-sale-order`
  - `/Feature/Financial/create-quotation`
- **Chart Issues**: Piechart ไม่แสดงข้อมูลเมื่อเอาเมาส์ไปชี้
  - `/Feature/Dashboard/dashboards`
  - `/Feature/Dashboard/report-category-sale`

### 🔐 **DISCUSS - รอหารือ**
- **สิทธิการเข้าถึง**: รอคุยกันเรื่อง Permission system

### 🐛 **BUGS**
- **Employee Update**: กรณีลบข้อมูล input ที่เคยมีอยู่จะ update ไม่ได้
- **Change Password**: เปลี่ยนรหัสผ่านพนักงานไม่ได้ (Backend)

## 📈 **Progress Summary**
- ✅ **DONE**: การจัดการลูกค้า, สินค้า, ใบเสนอราคา, ทีม, ข้อมูลพื้นฐาน
- 🔄 **IN PROCESS**: ใบสั่งขาย, ที่อยู่
- ⚠️ **PENDING**: Dashboard, รายงาน, การจัดการบริษัท/พนักงาน, กิจกรรม
